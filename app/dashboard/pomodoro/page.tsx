            ...
            <div className="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-3xl p-16 text-white shadow-2xl flex-1 flex flex-col">
              ...
              <div className="flex items-center justify-center mb-8">
                <div className="relative">
                  <button
                    ...
                    className={`px-6 py-3 bg-white/20 backdrop-blur-sm rounded-full transition-all flex items-center gap-2 ${
              ...
              <div className="text-center mb-12 flex-1 flex flex-col justify-center">
                <button
                  ...
                  disabled={pomodoroTimer.status !== 'idle'}
                  className={`text-9xl font-extralight mb-8 tracking-wider transition-transform ${
                    pomodoroTimer.status === 'idle'
