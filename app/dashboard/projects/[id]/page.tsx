...
import type { Project, ProjectJournal } from '@/lib/types/database';
...
export default function ProjectDetailPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'completed': return 'bg-teal-100 text-teal-700 border-teal-300';
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        ...
        <Link
          href="/dashboard/projects"
          className="inline-flex items-center text-gray-600 hover:text-emerald-700 mb-6 font-light transition-colors"
        >
          ← 返回项目列表
        </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border border-blue-200 p-6 shadow-md">
            <div className="flex justify-between items-center mb-6">
              ...
              <button className="px-4 py-2.5 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-all text-sm font-medium shadow-sm hover:shadow-md">
                + 添加任务
              </button>
            </div>
            ...
            <div className="space-y-3 max-h-[600px] overflow-y-auto">
              ...
              {/* 任务项示例 */}
              {/* <div className="flex items-start gap-3 p-4 bg-white/80 rounded-xl hover:bg-white transition-all cursor-pointer border border-blue-100">
                <input type="checkbox" className="mt-1 w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900">完成需求文档</p>
                  <p className="text-xs text-gray-500 mt-1">截止：2026/5/28</p>
                </div>
              </div> */}
            </div>
          </div>
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-gray-900">共享给伴侣</span>
                  <span className="text-lg">💕</span>
                </div>
                <p className="text-xs text-gray-600 mt-0.5">
                  开启后，你的伴侣可以在伴侣空间查看这个项目的进度
                </p>
              </div>
            </label>
          </div>
