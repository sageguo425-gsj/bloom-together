...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden px-4">
      ...
      {/* 渐变遮罩层 - 治愈绿色系 */}
      <div className="absolute inset-0 bg-gradient-to-tr from-emerald-900/70 via-teal-800/50 to-green-700/60" />

      {/* 装饰性光晕 */}
      <div className="absolute top-20 right-1/4 w-96 h-96 bg-emerald-400/20 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 left-1/4 w-96 h-96 bg-teal-400/20 rounded-full blur-3xl"></div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/15 backdrop-blur-2xl rounded-3xl p-8 md:p-10 border border-white/30 shadow-2xl">
          <div className="mb-8">
            <h2 className="text-2xl font-light text-white mb-2">登录</h2>
            <p className="text-emerald-100/70 text-sm">欢迎回来</p>
          </div>
